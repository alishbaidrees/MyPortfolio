...
<head>
<link rel="shortcut icon" type="image/x-icon" href="images/favicons/favicon (1).png">
...
<td>
<h2 class="table-avatar">
<a><?php echo $row['msg'] ?></a>
</h2>
</td>
<td>
<h2 class="table-avatar">
<a><?php echo $row['date_time'] ?></a>
</h2>
</td>
...
?>
	...
	<br>
<a class="btn btn-sm bg-danger-light mb-2" href="delete_contact.php">
						<i class="fe fe-minus"></i> Delete All Messages
</a>
...
if(isset($_POST['cbtn']))
{
	...
	$sql = "insert into contact (id,name,email,phone,msg) values (null,'$cname','$cemail','$cphone','$cmessage')";
